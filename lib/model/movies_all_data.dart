class MovieAll {
  ...
  late final int page;
  late final List<MovieInfo> results;
  late final int totalPages;
  late final int totalResults;

  MovieAll.fromJson(Map<String, dynamic> json) {
    dates = Dates.fromJson(json['dates']);
    page = json['page'];
    results =
        List.from(json['results']).map((e) => MovieInfo.fromJson(e)).toList();
...
class MovieInfo {
  ...
  static List<MovieInfo> listToMoves(List jsonList) {
